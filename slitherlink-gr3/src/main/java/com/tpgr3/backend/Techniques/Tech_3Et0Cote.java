...
public class Tech_3Et0Cote implements Techniques {
    ...
    public List<int[]> getSlotsToMark(Grille grille) {
        ...
        int[] savePosMilieu = positionMilieu;
        String saveBord = bord;
        boolean saveInverse = inverse;
        List<int[]> saveCroix = new ArrayList<>(slotsCroix != null ? slotsCroix : new ArrayList<>());
        List<int[]> saveBaton = new ArrayList<>(slotsBaton != null ? slotsBaton : new ArrayList<>());
