...
public class TechniquesPriority {
    ...
    public static final List<Class<? extends Techniques>> PRIORITY_ORDER = Arrays.asList(
        ...
        // Techniques spécifiques de coins
        ...
        // Techniques de détection de boucle avancées
